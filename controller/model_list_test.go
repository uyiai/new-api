...
func setupModelListControllerTestDB(t *testing.T) *gorm.DB {
	...
	require.NoError(t, db.AutoMigrate(&model.User{}, &model.Channel{}, &model.ChannelUpstreamRateLimitStatus{}, &model.ChannelPreparation{}, &model.Ability{}, &model.Model{}, &model.Vendor{}))
