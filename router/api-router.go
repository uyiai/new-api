	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/token", middleware.CriticalRateLimit(), middleware.DisableCache(), middleware.SecureVerificationRequired(), controller.GenerateAccessToken)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/search/keys", middleware.DisableCache(), controller.SearchChannelsByKeys)
			...
			channelRoute.GET("/import/profiles", controller.GetChannelImportProfiles)
			channelRoute.POST("/import", controller.ImportChannelsFromProfile)
			...
			channelRoute.GET("/preparations/auto-promotion/setting", controller.GetChannelPreparationAutoPromotionSetting)
			channelRoute.PUT("/preparations/auto-promotion/setting", controller.UpdateChannelPreparationAutoPromotionSetting)
			...
			channelRoute.GET("/balance-tier/setting", controller.GetBalanceTierSetting)
			channelRoute.PUT("/balance-tier/setting", controller.UpdateBalanceTierSetting)
			channelRoute.POST("/balance-tier/preview", controller.PreviewBalanceTierRules)
			channelRoute.POST("/balance-tier/apply", controller.ApplyBalanceTierRules)
			channelRoute.GET("/tag_stats", controller.GetChannelTagStats)
